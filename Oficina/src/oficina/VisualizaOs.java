...
public class VisualizaOs extends javax.swing.JFrame
{
    ...
    public void atualizaVisualizacao(){
        lbCodigoOsText.setText(Integer.toString(os.getCodigoOs()));
        lbPlacaText.setText(os.getPlacaCarro());
        lbCodClienteText.setText(os.getCodCliente());
        lblKmEntradaText.setText(os.getKmEntrada());
        lbKmSaidaText.setText(os.getKmSaida());
        lbDataInicioText.setText(os.getDataInicio());
        lbDataFimText.setText(os.getDataFim());
        lbHoraInicioText.setText(os.getHoraInicio());
        lbHoraFimText.setText(os.getHoraFim());
        lbTipoText.setText(os.getTipo());
        lbEstadoText.setText(os.getEstado());
        
        DefaultListModel d = (DefaultListModel) lServicos.getModel();

        while(!os.servicos.isEmpty())
        {
            d.addElement(os.servicos.remove(0));
        };
    ...
    private void initComponents()
    {
        ...
        btSair1.addMouseListener(new java.awt.event.MouseAdapter()
        {
            public void mouseClicked(java.awt.event.MouseEvent evt)
            {
                btSair1MouseClicked(evt);
            }
        });
    ...
    private void btSair1MouseClicked(java.awt.event.MouseEvent evt)//GEN-FIRST:event_btSair1MouseClicked
    {//GEN-HEADEREND:event_btSair1MouseClicked
        closeOp();
    }//GEN-LAST:event_btSair1MouseClicked
